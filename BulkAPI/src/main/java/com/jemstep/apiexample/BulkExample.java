...
public class BulkExample {
    ...
    public static void main(String[] args)
      throws AsyncApiException, ConnectionException, IOException {
        ...
        //example.retrieveBulkData("viknesh@brillio.com", "jemstep@2018@rLe7eakEoYPj6LkRsM3Tywa4","Account","SELECT AccountNumber FROM Account",null,null);
        //example.runSample("Account_PE__e", "viknesh@brillio.com", "jemstep@2018@rLe7eakEoYPj6LkRsM3Tywa4", "Account_PE.csv");
    }
    	...
    	try{
    		...
    		if (queryResults != null) {
    			...
    			for (String resultId : queryResults) {
    				GZIPInputStream gis = (GZIPInputStream) bulkConnection.getQueryResultStream(job.getId(),
    						info.getId(), resultId);
    				...
    				//		info.getId(), resultId);
    				//InputStream inputStream1=bulkConnection.getQueryResultStream(job.getId(),
